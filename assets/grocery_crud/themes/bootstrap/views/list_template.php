...
<?php echo form_open("", 'method="post" autocomplete="off" id="gcrud-search-form"'); ?>
                ...
                <?php if (!$unset_add) { ?>
                        <div class="floatL t5">
                            <a class="btn btn-sm btn-outline-success" href="<?php echo $add_url ?>">
...
<?php } ?>
                    <div class="floatR">
                    <?php if (!$unset_export) { ?>
                            <a class="btn btn-sm btn-default btn-outline-dark t5 gc-export" data-url="<?php echo $export_url; ?>" href="javascript:;">
...
<?php } ?>
                        <?php if (!$unset_print) { ?>
                            <a class="btn btn-sm btn-default btn-outline-dark t5 gc-print" data-url="<?php echo $print_url; ?>" href="javascript:;">
...
<?php } ?>
                ...
                <div class="scroll-if-required" style="padding-bottom: 100px">
                    <table class="table table-bordered table-striped grocery-crud-table">
                        <thead>
                            <tr>
                                <th class="thead-secondary" style="line-height: 25px; text-align: center" colspan="2" <?php if ($buttons_counter === 0) { ?>class="hidden"<?php } ?>>
<?php echo $this->l('list_actions'); ?>
                                </th>
                                    <?php foreach ($columns as $column) { ?>
                                    <th  style="line-height: 25px" class="column-with-ordering thead-secondary" data-order-by="<?php echo $column->field_name; ?>"><?php echo $column->display_as; ?></th>
                                <?php } ?>
                            </tr>
                                ...
                                <td class="no-border-left <?php if ($buttons_counter === 0) { ?>hidden<?php } ?>">
                                    <div class="floatL">
                                        <a href="javascript:void(0);" title="<?php echo $this->l('list_delete') ?>"
                                           class="hidden btn btn-xs btn-outline-danger delete-selected-button">
                                            <i class="fa fa-trash"></i>
<!--                                                <span class=""><?php // echo $this->l('list_delete') ?></span>-->
                                        </a>
                                    </div>
                                    <div class="floatR l5">
                                        <a href="javascript:void(0);" title="refresh" class="btn btn-xs btn-default btn-outline-dark gc-refresh">
...
<?php list($show_lang_string, $entries_lang_string) = explode('{paging}', $this->l('list_show_entries')); ?>
                        ...
                        <div class="floatL r5 l5">
                            <select name="per_page" class="per_page form-control" style="height: calc(1.75rem + 2px);">
...
<?php echo $entries_lang_string; ?>
                    ...
                    <div class="btn btn-sm-group floatR t20 l5 r5 settings-button-container">
                        <!--  <button type="button" class="btn btn-sm btn-default btn-outline-primary settings-button gc-bootstrap-dropdown dropdown-toggle">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-sm btn-secondary" data-dismiss="modal"><?php echo $this->l('form_cancel'); ?></button>
                        <button type="button" class="btn btn-sm btn-danger delete-confirmation-button"><?php echo $this->l('list_delete'); ?></button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-sm btn-danger delete-multiple-confirmation-button"
