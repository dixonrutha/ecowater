            ...
            <div class="col-md-12">
                ...
                <div class="form-container table-container">
                    ...
                    <div class="form-group gcrud-form-group">
                        <div id='report-error' class='report-div error bg-danger' style="display:none; background-color: #fbd2d6 !important"></div>
                        <div id='report-success' class='report-div success bg-success' style="display:none; background-color: #6eda9d !important;"></div>
                    </div>
                    <div class="form-group gcrud-form-group">
