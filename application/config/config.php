...
$config['firebase_app_key'] = APPPATH . '/config/evalidator-65ac4-firebase-adminsdk-2s5wn-4c1818f190.json';
...
|
*/
$config['base_url'] = 'http://localhost/ecowater/';
...
|
*/
$config['encryption_key'] = 'Ec0w@ter';
...
$config['sess_save_path'] = 'eco_ci_sessions';
