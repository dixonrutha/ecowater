            ...
            <table id="sub-table" class="table-bordered table-striped" style="border-collapse: collapse">
                ...
                <tbody>
                    ...
                    foreach ($subscribers as $s) {
                        ...
                        if ($s->sub_stat_dormancy === 'E') {
                            $perf = '<span class="badge badge-success">Excellent</span>';
                        } elseif ($s->sub_stat_dormancy === 'G') {
                            $perf = '<span class="badge badge-info">Good</span>';
                        } elseif ($s->sub_stat_dormancy === 'N') {
                            $perf = '<span class="badge badge-warning">Normal</span>';
                        } elseif ($s->sub_stat_dormancy === 'D') {
                            $perf = '<span class="badge badge-danger">Dormant</span>';
                        }
                        ?>
                        <tr>
                            <td id="table_td"><?= $s->card_no ?></td>
                            <td id="table_td"><?= $s->sub_name ?></td>
                            <td id="table_td"><?= $s->campus_name ?></td>
                            <td id="table_td"><?= $s->mobile ?></td>
                            <td id="table_td"><?= $s->category ?></td>
                            <td id="table_td" style="text-align: center"><?= $s->gender ?></td>
                            ...
                            <td id="table_td" style="text-align: center">
                                <div class="btn-group">
                                    <?php if (!empty($this->session->userdata('sub_topup'))) { ?>
                                                <!--<a href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="topup" class="btn btn-xs btn-outline-warning item_edit" data-sub_id="<?= $s->id ?>" data-sub_name="<?= $s->sub_name ?>" data-card_no="<?= $s->card_no ?>"><span class="fa fa-money"></span></a>-->
                                    <?php } ?>
                                    <?php if (!empty($this->session->userdata('sub_sms'))) { ?>
                                        <a href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="SMS" class="btn btn-xs btn-outline-success item_sms" data-sub_id="<?= $s->id ?>" data-sub_name="<?= $s->sub_name ?>" data-card_no="<?= $s->card_no ?>" data-mobile="<?= $s->mobile ?>"><span class="fa fa-commenting"></span></a>
                                    <?php } ?>
                                    <?php if (!empty($this->session->userdata('sub_mail'))) { ?>
                                        <a href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="email" class="btn btn-xs btn-outline-secondary item_mail" data-sub_id="<?= $s->id ?>" data-sub_name="<?= $s->sub_name ?>" data-card_no="<?= $s->card_no ?>" data-email="<?= $s->email ?>"><span class="fa fa-envelope"></span></a>
                                    <?php } ?>
