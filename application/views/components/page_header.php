        ...
        <!--  <div class="d-flex align-items-center justify-content-start">
          ...
          <div class="collapse" id="loggedinMenu">
            <ul class="nav nav-aside mg-b-0">
              <li class="nav-item"><a href="#Modal_Password" class="nav-link" data-toggle="modal" data-animation="effect-rotate-left"><i data-feather="lock"></i> <span>Password</span></a></li>
    ...
    <div class="content ht-100v pd-0">
      <div class="content-header" style="height: 50px;">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-style1 mg-b-3" style="background-color: #e9ecef0a">
